...
describe('DayPickerKeyboardShortcuts', () => {
  describe('#render', () => {
    describe('.DayPickerKeyboardShortcuts__show', () => {
      ...
      it('click calls props.toggleKeyboardShortcutsPanel', () => {
        const toggleKeyboardShortcutsPanelStub = sinon.stub();
        const wrapper = shallow(
          <DayPickerKeyboardShortcuts
            toggleKeyboardShortcutsPanel={toggleKeyboardShortcutsPanelStub}
          />,
        );
        const buttonWrapper = wrapper.find('.DayPickerKeyboardShortcuts__show');
        buttonWrapper.simulate('click');
        expect(toggleKeyboardShortcutsPanelStub.callCount).to.equal(1);
      });
    });
    ...
    describe('.DayPickerKeyboardShortcuts__panel', () => {
      ...
      describe('.DayPickerKeyboardShortcuts__close', () => {
        ...
        it('calls props.toggleKeyboardShortcutsPanel if clicked', () => {
          const toggleKeyboardShortcutsPanelStub = sinon.stub();
          const wrapper = shallow(
            <DayPickerKeyboardShortcuts
              showKeyboardShortcutsPanel
